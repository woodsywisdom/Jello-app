...
with app.app_context():
  ...
  readingListDemo = Board(title = 'Reading', description = 'My Reading list', user_id = 1, color="blue")
  myselfDemo = Board(title = 'Graph', description = 'Keeping tabs on myself', user_id = 1, color="red")
